...
class ExperimentRunner:
    ...
    def run(
        ...
        if setup_name == "cherry_pick_both_finmem":
            default_config = {
                "data_loader": FinsaberDataset(pickle_file="data/finmem_data/stock_data_cherrypick_2000_2024.pkl"),
            ...
            default_config = {
                "data_loader": FinsaberDataset(pickle_file="data/finmem_data/stock_data_sp500_2000_2024.pkl"),
                "date_from": "2004-01-01",
                "date_to": "2024-01-01",
                "tickers": "all",
                "silence": True,
